...
| [`compute_prominence`](../src/formosa/geomorphology/terrain.py) | `.geomorphology.terrain.compute_prominence` | Computes topographic prominence and divide-tree features for a DEM. | Fortran only | [Direct](../tests/test_terrain_f.py) | Returns `(proms, feats, feat_types, key_saddles, feat_prnts)`; supports direction schemes and validity masks. |
